                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-0">
                                        <div class="img1 wow fadeInRight effect" data-wow-duration="1s" data-wow-delay="0s">
                                            <img src="admin/image/<?php $arr=explode("/",$details['img']);echo$arr[0]; ?>" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                ...
                                <div class="ftr-product">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="all" role="tabpanel">
                                            ...
                                            <div class="tab-item">
                                                    <div class="tab-img">
                                                        <img class="main-img img-fluid" src="admin/image/<?php $arr=explode("/",$row['img']);echo$arr[0]; ?>" alt="">
                                                        <img class="sec-img img-fluid" src="admin/image/<?php $arr=explode("/",$row['img']);echo$arr[1]; ?>" alt="">
                                                        <div class="layer-box">
                                                    ...
                                                    <div class="img-content d-flex justify-content-between">
                                                        <div>
                                                            ...
                                                            <ul class="list-unstyled list-inline price">
                                                                <li class="list-inline-item">$<?php echo$row['price'] ?></li>
