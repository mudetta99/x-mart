                ...
                <div class="row">
                                ...
                                <tbody>
                                    ...
                                    foreach($select as $row){
                                        ...
                                        <td class="t-pro d-flex">
                                            ...
                                            <div class="t-content">
                                                <p class="t-heading"><a href="#"><?php echo$details['name'] ?></a></p>
                                        ...
                                        <td class="t-price"><?php echo$details['price'] ?></td>
                                        <td class="t-qty">
                                            <div class="qty-box">
                                                <div class="quantity buttons_added">
                                                    <!-- <input type="button" value="-" class="minus"> -->
                                                    <input type="number" value="<?php echo$row['quan'] ?>" class="qty text" size="4" readonly>
                                                    <!-- <input type="button" value="+" class="plus"> -->
                                                </div>
                                            </div>
                                        </td>
                                        
                                        <td class="t-total">$ <?php echo $total ?></td>
                                        <td class="t-rem ">
                                            <button  class="btn btn-danger x_delete" prod_id="<?php echo$details['id']?>" client_id="<?php echo$id?>"><i class="fa fa-trash-o"></i></button>
                                        </td>
                                    </tr>
                                    ...
                                    array_push($arr,$details['price']);
                                    // $sale = array_push($arr_s,$details['sale']);
                    ...
                    <div class="col-md-4">
                        <div class="crt-sumry">
                            <h5>Cart Summery</h5>
                            <ul class="list-unstyled">
                                <li>Subtotal <span>$ <?php echo $sum ?></span></li>
                                <li>Shipping & Tax <span>$ <?php echo $sum_s ?> <?php ?></span></li>
                                <li>Grand Total <span>$<?php echo $sum - $sum_s ?></span></li>
                            </ul>
