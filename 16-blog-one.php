                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-box">
                                <div class="blog-img">
                                <a href="#"><img src="admin/image/<?php echo$row['img'] ?>" alt="" class="img-fluid"></a>
                                </div>
                            <div class="blog-content">
                                <h5><a><?php echo$row['title'] ?> </a></h5>
                                <ul class="list-unstyled list-inline">
                                    <li class="list-inline-item"><i class="fa fa-user-o"></i><a><?php echo$row['publisher'] ?></a></li>
                                    <li class="list-inline-item"><i class="fa fa-calendar"></i><?php echo$row['date'] ?></li>
                                </ul>
                                <p><?php echo$row['description'] ?></p>
                                <button class="btn btn-warning"><a href="<?php echo$row['link'] ?>" target="_blank">Details</a></button>
                            </div>
                        </div>
        			</div>
