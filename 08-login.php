<?php
    if(isset($_SESSION['login_c'])){
        ...
        $id = $_SESSION['login_c'];
        $select = $connect -> query("SELECT * FROM client WHERE id = '$id'");
...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/08-login.phpl by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:46 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <div class="carts-area d-flex">
                            <div class="wsh-box ml-auto">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Wishlist">
                                    ...
                                    <span <?php if(!isset($_SESSION['login_c'])){echo "hidden";} ?> >0</span>
                                </a>
                            </div>
                            <div class="cart-box ml-4">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Shopping Cart" class="cart-btn">
                                    <img src="images/cart.png" alt="cart">
                                    <span <?php if(!isset($_SESSION['login_c'])){echo "hidden";} ?>>2</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3">
                        <div class="sticky-logo">
                            <a href="index-2.phpl"><img src="images/logo.png" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                            ...
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item"><a>HOME <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="index-2.phpl">Home Style 1</a></li>
                                        <li><a href="02-home-two.phpl">Home Style 2</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="list-inline-item"><a>PAGES <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="03-about-us.phpl">About Us</a></li>
                                        <li><a href="04-category.phpl">Category</a></li>
                                        <li><a href="05-single-product.phpl">Single Product</a></li>
                                        <li><a href="06-shopping-cart.phpl">Shopping Cart</a></li>
                                        <li><a href="07-checkout.phpl">Checkout</a></li>
                                        <li><a href="08-login.phpl">Log In</a></li>
                                        <li><a href="09-register.phpl">Register</a></li>
                                        <li><a href="10-wishlist.phpl">Wishlist</a></li>
                                        <li><a href="11-compare.phpl">Compare</a></li>
                                        <li><a href="15-track-order.phpl">Track Order</a></li>
                                        <li><a href="12-terms-condition.phpl">Terms & Condition</a></li>
                                        <li><a href="13-faq.phpl">Faq</a></li>
                                        <li><a href="14-404.phpl">404</a></li>
                                    </ul>
                                </li>
                                <li class="list-inline-item"><a>BLOG <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="16-blog-one.phpl">Blog Style 1</a></li>
                                        <li><a href="17-blog-two.phpl">Blog Style 2</a></li>
                                        <li><a href="18-blog-three.phpl">Blog Style 3</a></li>
                                        <li><a href="19-blog-details.phpl">Blog Details</a></li>
                                    </ul>
                                </li>
                                <li class="list-inline-item"><a href="20-contact.phpl">CONTACT</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="mobile-menu">
                            <nav id="dropdown">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="20-contact.phpl">Contact</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="r-customer">
                            ...
                            <form action="admin/function/client_log.php" method="post">
                                <div class="emal">
                                ...
                                <div class="d-flex justify-content-between nam-btm">
                                    ...
                                    <div>
                                        <a href="lostpass.php?id=<?php echo $user['id']; ?>">Lost your password?</a>
                                    </div>
                                </div>
