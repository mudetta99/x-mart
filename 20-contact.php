                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="contact-form">
                            <h4>Get In Touch</h4>
                            <form action="admin/function/contact.php" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><input type="text" id="name" name="name" value="<?php if(isset($id)){echo$user['name'];} ?>" placeholder="Full Name" required=""></p>
                                     </div>
                                    <div class="col-md-6">
                                        <p><input type="text" id="email" name="email" value="<?php if(isset($id)){echo$user['email'];} ?>" placeholder="Email" required=""></p>
                                    </div>
                                    <div class="col-md-12">
