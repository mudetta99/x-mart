                        ...
                        <div class="carts-area d-flex">
                            ...
                            <div class="cart-box ml-4">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Shopping Cart" class="cart-btn">
                                    ...
                                    <?php
                                    $id = $_SESSION['login_c'];
                                    $select_num = $connect -> query("SELECT * FROM cart WHERE client_id ='$id'");
                        ...
                        <div class="category-box">
                            ...
                            <div id="accordion">
                                <div class="card">
                                    ...
                                    $select = $connect -> query("SELECT * FROM category");
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="grid" role="tabpanel">
                                    ...
                                    if(isset($_GET['id'])){
                                        ...
                                        $page = $_GET['page'];
                                        $prod_in_page = 6;
                                        $offset = ($page - 1) * $prod_in_page;
                                        $select = $connect -> query("SELECT * FROM products WHERE cat_id='$id' LIMIT ".$offset.",".$prod_in_page);
                                        }else{
                                        ...
                                        if(isset($_GET['page'])){
                                            ...
                                            $prod_in_page = 6;
                                            $offset = ($page - 1)* $prod_in_page;
                                            $select = $connect -> query("SELECT * FROM products LIMIT ".$offset.",".$prod_in_page);
                                        }else{
...
<img width="255" class="main-img img-fluid" src="admin/image/<?php $arr=explode("/",$row['img']); echo$arr[0];?>" alt="">
<img width="255" class="sec-img img-fluid" src="admin/image/<?php $arr=explode("/",$row['img']); echo$arr[1];?>" alt="">

                                                    
                                                    <div class="layer-box">
                                                        <a href="#" class="it-comp" data-toggle="tooltip" data-placement="left" title="Compare"><img src="images/it-comp.png" alt=""></a>
                                                        <a href="#" class="it-fav" data-toggle="tooltip" data-placement="left" title="Favourite"><img src="admin/image/<?php echo$row['img'] ?>" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="tab-heading">
                                                    <p><a href="05-single-product.php?id=<?php echo$row['id']?>"><?php echo$row['name'] ?></a></p>
                                                </div>
                                                <div class="img-content d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <ul class="list-unstyled list-inline fav">
                                                            ...
                                                            <li class="list-inline-item"><i  <?php if($row['rate'] > 0){echo "class='fa fa-star'";}else{echo "class='fa fa-star-o'";} ?>></i></li>
                                                            <li class="list-inline-item"><i  <?php if($row['rate'] > 1){echo "class='fa fa-star'";}else{echo "class='fa fa-star-o'";} ?> ></i></li>
                                                            <li class="list-inline-item"><i  <?php if($row['rate'] > 2){echo "class='fa fa-star'";}else{echo "class='fa fa-star-o'";} ?> ></i></li>
                                                            <li class="list-inline-item"><i  <?php if($row['rate'] > 3){echo "class='fa fa-star'";}else{echo "class='fa fa-star-o'";} ?> ></i></li>
                                                            <li class="list-inline-item"><i  <?php if($row['rate'] > 4){echo "class='fa fa-star'";}else{echo "class='fa fa-star-o'";} ?>></i></li>
                                                        </ul>
                                                    ...
                                                    <div>
                                                        <a href="#" class="x_cart" prod_id="<?php echo$row['id']?>" client_id="<?php echo$id_c?>" data-toggle="tooltip" data-placement="top" title="Add to Cart"><img src="images/it-cart.png" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="pagination-box text-center">
                                ...
                                if(isset($_GET['id'])){
                                    ...
                                    $prod_in_page = 6;
                                    $select = $connect -> query("SELECT * FROM products WHERE cat_id='$id'");
                                    $numbers = $select -> num_rows;
                                    $pages = ceil($numbers/$prod_in_page);
                                    for($i=1;$i<=$pages;$i++){
                                ...
                                $pages = ceil($numbers/$prod_in_page);
                                ?>
                                <li <?php if($page == 1){echo "hidden";} ?> class="list-inline-item"><a href="?page=<?php echo$page-1 ?>"><i class="fa fa-angle-left"></i></a></li>
                                <?php
                                for($i=1;$i<=$pages;$i++){
                                    
                                    ?>
                                    <li class="list-inline-item"><a href="?page=<?php echo$i?>"><?php echo$i ?></a></li>
                               <?php } }?>
                                        ...
                                        ?>
                                    <li class="list-inline-item"><a href="?page=<?php echo$page+1 ?>"><i class="fa fa-angle-right"></i></a></li>
                                    <li class="list-inline-item"><a href="?page=<?php echo$page+3 ?>"><i class="fa fa-angle-double-right"></i></a></li>
