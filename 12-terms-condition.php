...
<!-- Mirrored from www.thetahmid.com/themes/xemart-v1.0/12-terms-conditiond.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jan 2022 22:15:46 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3">
                        <div class="sticky-logo">
                            <a href="index-2d.php"><img src="images/logo.png" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                            ...
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item"><a>HOME <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="index-2d.php">Home Style 1</a></li>
                                        <li><a href="02-home-twod.php">Home Style 2</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="list-inline-item"><a>PAGES <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="03-about-usd.php">About Us</a></li>
                                        <li><a href="04-categoryd.php">Category</a></li>
                                        <li><a href="05-single-productd.php">Single Product</a></li>
                                        <li><a href="06-shopping-cartd.php">Shopping Cart</a></li>
                                        <li><a href="07-checkoutd.php">Checkout</a></li>
                                        <li><a href="08-logind.php">Log In</a></li>
                                        <li><a href="09-registerd.php">Register</a></li>
                                        <li><a href="10-wishlistd.php">Wishlist</a></li>
                                        <li><a href="11-compared.php">Compare</a></li>
                                        <li><a href="15-track-orderd.php">Track Order</a></li>
                                        <li><a href="12-terms-conditiond.php">Terms & Condition</a></li>
                                        <li><a href="13-faqd.php">Faq</a></li>
                                        <li><a href="14-404d.php">404</a></li>
                                    </ul>
                                </li>
                                <li class="list-inline-item"><a>BLOG <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="16-blog-oned.php">Blog Style 1</a></li>
                                        <li><a href="17-blog-twod.php">Blog Style 2</a></li>
                                        <li><a href="18-blog-threed.php">Blog Style 3</a></li>
                                        <li><a href="19-blog-detailsd.php">Blog Details</a></li>
                                    </ul>
                                </li>
                                <li class="list-inline-item"><a href="20-contactd.php">CONTACT</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="mobile-menu">
                            <nav id="dropdown">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="20-contactd.php">Contact</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
