<?php
    ...
    $id = $_SESSION['login_c'];
    $prod_id = $_GET['id'];
    $select = $connect -> query("SELECT * FROM products WHERE id='$prod_id'");
    ...
    <body>
                                ...
                                <div class="sg-img">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="sg1" role="tabpanel">
                                            <img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[0]; ?>" alt="" class="img-fluid">
                                        </div>
                                        <div class="tab-pane" id="sg2" role="tabpanel">
                                            <img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[1]; ?>" alt="" class="img-fluid">
                                        </div>
                                        <div class="tab-pane" id="sg3" role="tabpanel">
                                            <img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[2]; ?>" alt="" class="img-fluid">
                                        </div>
                                        <div class="tab-pane" id="sg4" role="tabpanel">
                                            <img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[3]; ?>" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                    <div class="nav d-flex justify-content-between">
                                        <a class="nav-item nav-link active" data-toggle="tab" href="#sg1"><img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[0]; ?>" alt=""></a>
                                        <a class="nav-item nav-link" data-toggle="tab" href="#sg2"><img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[1]; ?>" alt=""></a>
                                        <a class="nav-item nav-link" data-toggle="tab" href="#sg3"><img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[2]; ?>" alt=""></a>
                                        <a class="nav-item nav-link" data-toggle="tab" href="#sg4"><img src="admin/image/<?php $arr=explode("/",$prod['img']);echo$arr[3]; ?>" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="sg-content">
                                    <div class="pro-tag">
                                        <ul class="list-unstyled list-inline">
                                            <li class="list-inline-item"><a href="#"><?php echo$cat ?></a></li>
                                     ...
                                     <div class="pro-rating">
                                        <?php
                                        $id_c = $_SESSION['login_c'];
                                        ?>
                                         <ul class="list-unstyled list-inline" prod_id="<?php echo$prod['id']?>" client_id="<?php echo$id_c?>">
                                            
                                             <li class="list-inline-item click" count='1'><i <?php if($prod['rate'] > 0){echo "class='fa fa-star'";}else{
                                                echo "class='fa fa-star-o'";} ?> ></i></li>
                                             <li class="list-inline-item click" count='2'><i <?php if($prod['rate'] > 1){echo "class='fa fa-star'";}else{
                                                echo "class='fa fa-star-o'";} ?> ></i></li>
                                             <li class="list-inline-item click" count='3'><i <?php if($prod['rate'] > 2){echo "class='fa fa-star'";}else{
                                                echo "class='fa fa-star-o'";} ?> ></i></li>
                                             <li class="list-inline-item click" count='4'><i <?php if($prod['rate'] > 3){echo "class='fa fa-star'";}else{
                                                echo "class='fa fa-star-o'";} ?> ></i></li>
                                             <li class="list-inline-item click" count='5'><i <?php if($prod['rate'] > 4){echo "class='fa fa-star'"; }else{
                                                echo "class='fa fa-star-o'";} ?> ></i></li>
                                     ...
                                     <div class="pro-price">
                                         <ul class="list-unstyled list-inline">
                                             <li class="list-inline-item">$<?php echo$prod['price'] - $prod['sale'] ?></li>
                                             <li style="font-size:18px" class="list-inline-item  ">$<?php if($prod['price'] > $prod['sale']){echo$prod['price'];} ?></li> <br>
                                             <p style="font-size:18px" class="text-danger" >Sale</p><li class="list-inline-item ">$<?php echo$prod['sale'] ?></li>
                                             <div>
                                                <h5 class="text text-danger">Description</h5>
                                                <p style="font-size:20px"><?php echo$prod['description'] ?></p>
                                             </div>


                                             
                                         </ul>
                                         <p>Availability : <span>In Stock</span> <label><?php echo$prod['quan'] ?></label></p>
                                     </div>
                                     <div class="colo-siz">
                                         <div class="color">
                                             <ul class="list-unstyled list-inline">
                                         ...
                                         <div class="pro-btns">
                                              ...
                                              <a href="#" class="cart x_cart" prod_id="<?php echo$prod['id']?>" client_id="<?php echo$id?>">Add To Cart</a>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="rev" role="tabpanel">
                                            ...
                                            <div class="review-form">
                                                ...
                                                <form action="admin/function/client_review.php" method="post">
                                                    <div class="row">
                                                        <div class="col-md-12">
        ...
        <script>
            $(document).ready(function(){
                ...
                $(".x_cart").click(function(){
                    var client_id = $(this).attr("client_id"),
                    prod_id = $(this).attr("prod_id")
                    $.post("admin/function/cart.php",{x_prod:prod_id,x_client:client_id},function(data){
                        // alert(data);
                    })
                })
                ...
                $(".click").click(function(){
                    let prod_id = $(this).closest("ul").attr("prod_id"),
                        client_id = $(this).closest("ul").attr("client_id"),
                        count = $(this).attr("count");
                $.post("admin/function/rate.php",{
                    x_prod:prod_id,
                    x_client:client_id,
                    x_count:count},function(data){
                        // alert(data);
                    })
                })
                })
